...
internal partial class OOBEViewModel : ObservableRecipient, INavigationAware, ISettingsViewModel
{
...
#if DEBUG 
    public string Edition { get; } = LocalizationResourcesUtils.GetValue("Settings", "AboutPage", "_Debug");
#else 
            ...
            App.DispatcherQueue.TryEnqueue(() =>
            {
                if (MinecraftFolders.Contains(folder.Path))
                {
                    _notificationService.NotifyMessage(
                        LocalizationResourcesUtils.GetValue("Notifications", "_AddFolderExistedT"),
                        LocalizationResourcesUtils.GetValue("Notifications", "_AddFolderExistedD"),
                        icon: "\uF89A");
    ...
    public void DetectOfficialMinecraftFolder()
    {
        ...
        {
            _notificationService.NotifyMessage(
                LocalizationResourcesUtils.GetValue("Notifications", "_AddOfficialFolderNotExistT"),
                LocalizationResourcesUtils.GetValue("Notifications", "_AddOfficialFolderNotExistD").Replace("${path}", OfficialLauncherPath),
                icon: "\uF89A");
        ...
        {
            _notificationService.NotifyMessage(
                LocalizationResourcesUtils.GetValue("Notifications", "_AddOfficiaFolderExistedT"),
                LocalizationResourcesUtils.GetValue("Notifications", "_AddOfficiaFolderExistedD").Replace("${path}", OfficialLauncherPath),
                icon: "\uF89A");
        ...
        _notificationService.NotifyMessage(
            LocalizationResourcesUtils.GetValue("Notifications", "_AddOfficiaFolderAddedT"),
            LocalizationResourcesUtils.GetValue("Notifications", "_AddOfficiaFolderAddedD").Replace("${path}", OfficialLauncherPath),
            icon: "\uE73E");
    }
    ...
    public void SearchJava()
    {
        ...
        _notificationService.NotifyWithoutContent(
            LocalizationResourcesUtils.GetValue("Notifications", "_AddSearchedJavaT"),
            icon: "\uE73E");
    }
    ...
    public string NextText
    {
        ...
        {
            if (CurrentPageIndex == OOBEPageKeys.Length - 1)
                return LocalizationResourcesUtils.GetValue("OOBE_OOBEViewModel__ButtonGetStarted");
            else
                return LocalizationResourcesUtils.GetValue("OOBE_OOBEViewModel__ButtonNext");
        }
    }
