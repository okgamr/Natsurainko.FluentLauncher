...
internal class AccountInfoConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        ...
        {
            var account = LocalizationResourcesUtils.GetValue("Converters", "_Account");

            return accountType switch
            {
                AccountType.Microsoft => LocalizationResourcesUtils.GetValue("Converters", "_Microsoft") + account,
                AccountType.Yggdrasil => LocalizationResourcesUtils.GetValue("Converters", "_Yggdrasil") + account,
                _ => LocalizationResourcesUtils.GetValue("Converters", "_Offline") + account,
            };
        }
